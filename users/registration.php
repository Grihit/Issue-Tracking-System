...
<html lang="en">
  <head>
    ...
    <title>Issue Tracking System | User Registration</title>
...
error:function (){}
  ...
  <body>
	  <div id="login-page">
	  	<div class="container">
		  <header class="header black-bg"><h2 style="text-align:center;color:white;">Issue Tracking System </h2></header>
	<hr />
